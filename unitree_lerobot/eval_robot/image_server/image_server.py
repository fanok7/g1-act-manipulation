...
# Modified for the I-Interim G1 setup: see PIPELINE_G1.md
...
try:
    ...
    rs = None  # non installé sur ce Jetson ; mode opencv uniquement
import logging_mp
...
if __name__ == "__main__":
    config = {
        ...
        "head_camera_image_shape": [480, 640],  # UGREEN Camera 2K, flux couleur 640x480
        "head_camera_id_numbers": [6],          # /dev/video6 = UGREEN Camera 2K (même cam que dataset G1_Bottle)
        # Pas de caméra poignet sur ce robot (cf. patch make_robot.py)
    }
